...
export const paymentService = {
  createRazorpayOrder: (payload: unknown) => api.post('/razorpay/create-order', payload),
  verifyRazorpayPayment: (payload: unknown) => api.post('/razorpay/verify-payment', payload),
};
