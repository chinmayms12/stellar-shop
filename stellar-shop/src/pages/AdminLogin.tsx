...
export function AdminLogin() {
  ...
  const submit=async(e:React.FormEvent)=>{e.preventDefault();setBusy(true);
    try {
      ...
      dispatch(addToast({message:'Authentication succeeded, but this account is not marked as an administrator. Run supabase/fix_admin_login.sql in Supabase SQL Editor.',type:'error'}));
    } catch (error) {
