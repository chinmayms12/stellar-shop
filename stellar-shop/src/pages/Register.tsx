...
import { getAuthErrorMessage, signInWithOAuthProvider, signUpWithSupabase } from '@/services/supabase';
...
export function Register() {
  ...
  const socialSignup = async (provider: SocialProvider) => {
    ...
    setBusy(false);
    if (result.error) dispatch(addToast({ message: getAuthErrorMessage(result.error), type: 'error' }));
  };
