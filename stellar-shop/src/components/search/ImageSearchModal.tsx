          ...
          >
            ...
            {!preview ? (
              ...
              <>
                ...
                <div className="mt-3 flex items-start gap-2 rounded-lg bg-soft px-3 py-2 text-xs text-muted">
                  <ImageIcon className="mt-0.5 h-4 w-4 shrink-0" />
                  Image upload is available, but visual similarity matching is not connected to a backend in this project. No fake products are shown.
                </div>
